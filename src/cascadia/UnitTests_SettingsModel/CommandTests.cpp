...
namespace SettingsModelUnitTests
{
    class CommandTests : public JsonTestClass
    {
        ...
        TEST_METHOD(TestGenerateCommandlineWithRestoredTabId);
    };
    ...
    void CommandTests::TestGenerateCommandlineWithRestoredTabId()
    {
        NewTerminalArgs args{};
        VERIFY_ARE_EQUAL(L"", args.ToCommandline());

        args.RestoredTabId(L"restore-id-123");
        VERIFY_ARE_EQUAL(L"--restoredTabId \"restore-id-123\"", args.ToCommandline());

        args.Profile(L"foo");
        VERIFY_ARE_EQUAL(L"--profile \"foo\" --restoredTabId \"restore-id-123\"", args.ToCommandline());
    }
}
